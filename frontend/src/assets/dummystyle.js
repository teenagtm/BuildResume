export const landingPageStyles = {
  ...
  // Header styles
  header: "fixed top-3 w-full z-50 bg-white/70 backdrop-blur-xl border-b border-violet-100/50",
  ...
  // Buttons
  primaryButton: "group relative px-9 py-4 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-bold rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-2xl hover:shadow-violet-200",
  ...
  ctaButton: "group relative px-8 sm:px-19 py-3 sm:py-4 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-black text-lg rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-2xl hover:shadow-violet-200",
  ctaButtonOverlay: "absolute inset-0 bg-gradient-to-r from-fuchsia-600 to-orange-500 opacity-100 group-hover:opacity-100 transition-opacity",
  ctaButtonText: "items-center",
...
export const buttonStyles = {
  theme: "flex items-center gap-2 px-3 sm:px-4 py-2 bg-violet-100 text-violet-900 font-bold rounded-xl hover:bg-violet-500 transition-all",
